...
void main() {
  ...
  group('RobotSimulator: Exception Handling - ',  exceptionHandling);
}
...
void exceptionHandling() {
  test('Trying an invalid command', () {
    final robot = Robot(Position(0, 0), Orientation.north);
    robot.move("G");
    expected(robot, beAt: Position(0, 0), faceTo: Orientation.north);
  }, skip: false);
  test('Trying an invalid sequence, should ignore invalid command', () {
    final robot = Robot(Position(0, 0), Orientation.north);
    robot.move("RhAAL");
    expected(robot, beAt: Position(2, 0), faceTo: Orientation.north);
  });
}
